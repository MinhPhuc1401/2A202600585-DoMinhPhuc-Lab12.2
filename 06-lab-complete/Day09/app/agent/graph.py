...
from app.agent.utils import timestamp_utc, extract_json_payload, dump_json
...
class ShoppingAssistant:
    ...
    def __init__(self, settings: Settings | None = None) -> None:
        ...
        from app.agent.data_access import build_data_tools
