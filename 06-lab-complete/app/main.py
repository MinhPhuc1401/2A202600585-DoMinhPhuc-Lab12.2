...
from app.cost_guard import check_and_record_cost, get_daily_cost_usd

# Global reference for the agent assistant
assistant = None
...
# Security dependencies imported from auth, rate_limiter, cost_guard
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # Keep _is_ready as False to indicate failure
